...
// New Promotion to GM button
    public Button promoteToGMButton;
// New Revoke GM Promotion button
    public Button revokeGMPromotionButton;
...
// Promotion to GM
                promoteToGMButton.onClick.SetListener(() => {
                    UIConfirmation.singleton.Show("Are you sure to give the player GM?", () => {
                        player.gameMasterTool.CmdPromoteToGM(playerNameInput.text); // Pass the player's name as parameter
                    });
                });

// Revoke GM Promotion
                revokeGMPromotionButton.onClick.SetListener(() => {
                    UIConfirmation.singleton.Show("Are you sure to revoke GM promotion from the player?", () => {
                        player.gameMasterTool.CmdRevokeGM(playerNameInput.text); // Pass the player's name as parameter
                    });
                });
